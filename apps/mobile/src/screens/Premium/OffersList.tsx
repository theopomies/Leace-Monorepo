  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.view}>
        <Header />
        <View>
          <Text className={`text-custom ml-2 pt-2 text-3xl font-bold`}>
            Subscription
          </Text>
          ...
          <View className={`flex flex-col`}>
            {features.map((feature, index) => (
              <React.Fragment key={index}>
                <View className={`ml-2 flex flex-row items-center space-y-3`}>
                  <Icon
                    name={feature.icon}
                    color={feature.color}
                    type={feature.type}
                ...
                <Text className={`ml-11 font-bold text-gray-800`}>
                  {feature.description}
                </Text>
              </React.Fragment>
            ))}
          ...
          <View
            className={`flex h-72 flex-row items-center justify-center px-4`}
          >
        ...
        <View className="items-center">
          <TouchableOpacity
            className={`bg-navy w-1/2 items-center justify-center rounded-lg px-6 py-3`}
            onPress={() => {
