...
// import { Post, Relationship, User } from "@leace/db";
...
// export default function OwnerLikes() {
//   const [idx, setIdx] = useState(0);
//   const { data: session } = trpc.auth.getSession.useQuery();

//   const userId = session?.userId as string;

//   const { data: rs, isLoading } = trpc.relationship.getLikesForOwner.useQuery({
//     userId,
//   });

//   const [currentUserIndex, setCurrentUserIndex] = useState(0);

//   const otherId = rs?.relationship?.[currentUserIndex]?.userId as string;
...
//   const [post, setPost] = useState<Relationship & { user: User; post: Post }>();
...
//       userId: rs?.relationship?.[currentUserIndex]?.user.id as string,
