...
const ReportModal = ({
  ...
  const reportButton = (reason: Reason) => {
    reportUser.mutate({
      postId: reportUser.data?.id as string,
      reason: reason,
    });
  };
          ...
          <View className="items-center">
            ...
            <Picker
              ...
              onValueChange={(itemValue) =>
                setSelectedValue(itemValue as Reason)
              }
            >
            ...
            <Button
              title="Submit"
              className="mx-9 mb-4 mt-20 rounded bg-blue-500 px-4 py-1 font-bold text-white hover:bg-blue-700"
              onPress={() => {
