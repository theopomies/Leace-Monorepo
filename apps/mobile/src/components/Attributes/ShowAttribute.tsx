...
const ShowAttribute = ({ title, name, type }: { title: string, name: string, type: string }) => {
    return (
        <View className="bg-transparent border rounded-full border-custom h-8 w-24 mr-1 mb-1 flex-row justify-center items-center">
            <Icon name={name} type={type} color="#002642" size={15} />
