...
export function OccupiedPropertiesList({ userId }: AvailablePropertiesListProps) {
    const occupied = trpc.post.getPostsByUserId.useQuery({userId: userId, postType: PostType.RENTED});
